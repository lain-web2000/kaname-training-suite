...
.ifdef ANN
      ...
      .byte $20,$e6,$15,$f1,$f1,$f1,$f1,$f1,$f1,$f1,$f1,$26,$26,$d4,$d5,$d4,$d9,$db,$e2,$d4,$da,$db,$e0,$26
      .byte $21,$06,$55,$26
...
.else
       ...
       .byte $26, $f1, $f1, $f1, $f1, $f1, $f1, $f1, $f1, $26, $26, $26, $26
