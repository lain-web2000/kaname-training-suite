...
cat smb/smborg-sprites.chr smb/smborg-back.chr smborg-lost-charset.chr \
	...
	intro/intro-bg.chr intro-sprbank0.chr intro-sprbank0.chr intro-sprbank0.chr intro-sprbank0.chr intro-sprbank0.chr intro-sprbank0.chr intro-sprbank0.chr > full.chr
